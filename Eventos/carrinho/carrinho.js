...
module.exports = {
  ...
  interaction.channel.send({
    embeds:[
      ...
      .setDescription(`
👤 Nome: Tawan Bryan Alves Pereira

💠 Chave Pix:
63999181478

💸 Valor:
R$ ${Number(Number(dbss.quantidade) * Number(prod.valor)).toFixed(2)}

⚠️ Após pagar envie o comprovante neste canal.
`)
    ],
    components:[
      new ActionRowBuilder()
...
interaction.channel.send({
  content: `✅ Pagamento Pix gerado com sucesso!`,
  components: [
    new ActionRowBuilder()
    .addComponents(
      new ButtonBuilder()
